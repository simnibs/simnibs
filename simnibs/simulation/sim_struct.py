...
class LEADFIELD():
    ...
    interpolation : None | str | list | tuple
        ...
        on the surfaces generated by either 'mri2mesh' or 'headreco'. If list
        or tuple, a sequence of filenames of surface meshes to interpolate the
        solution to (default = 'middle gm').
...
class TDCSLEADFIELD(LEADFIELD):
    ...
    def run(self, cpus=1, allow_multiple_runs=False, save_mat=True):
        ...
        if self.interpolation:
            ...
            M = roi_msh.interp_matrix(mesh_lf.nodes.node_coord,
                                      out_fill='nearest', element_wise=True)
        ...
        with h5py.File(fn_hdf5, 'a') as f:
            ...
            if self.interpolation:
                ...
                f[dset].attrs['interpolation'] = 'True'
            else:
