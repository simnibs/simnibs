"""
Example to run TESoptimize with an HDTES montage
"""
...
# output folder
opt.output_folder = f"/data/pt_01756/studies/ttf/optimization/ernie/HDTES/maxmean/test"
...
electrode.distance = [25, 100]                                          # distance between inner and outer electrodes
electrode.n_outer = 4                                                   # number of outer electrodes
electrode.dirichlet_correction = True                                   # electrode wise dirichlet correction
