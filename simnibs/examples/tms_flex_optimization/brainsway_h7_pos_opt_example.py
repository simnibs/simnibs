# -*- coding: utf-8 -*-
"""
Created on Wed Jun 12 10:29:02 2024
...
# Define coil
coil_path = os.path.join('flexible_coils', 'Brainsway_H7.tcd')
...
h7_translation_ranges = np.array([[-5, 5], [-5, 5], [-30, 30]])
h7_rotation_ranges = np.array([[-30, 30], [-10,10], [-5, 5]])
...
tms_opt.global_translation_ranges = h7_translation_ranges
tms_opt.global_rotation_ranges = h7_rotation_ranges
