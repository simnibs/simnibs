...
roi.subpath = "/mnt/c/Users/torwo/Documents/Projects/simnibs4_examples/m2m_ernie"
roi.method = "volume"
roi.tissues = [ElementTags.WM, ElementTags.GM]
roi.roi_sphere_center_space = (
    "subject"  # center of spherical ROI in subject space (in mm)
)
...
non_roi.subpath = "/mnt/c/Users/torwo/Documents/Projects/simnibs4_examples/m2m_ernie"
...
roi_result_vis = RoiResultVisualization(
    [roi, non_roi],
    [
        "/mnt/c/Users/torwo/Documents/Projects/simnibs4_examples/tes_optimize_ttf_focality/final_sim_0/ernie_TDCS_1_scalar.msh",
        "/mnt/c/Users/torwo/Documents/Projects/simnibs4_examples/tes_optimize_ttf_focality/final_sim_1/ernie_TDCS_1_scalar.msh",
    ],
    ["roi", "avoiding_zone"],
    ["ttf_1", "ttf_2"],
)
...
if roi_result_vis.has_head_mesh():
    roi_result_vis.get_head_mesh().add_element_field(
        np.random.rand(roi_result_vis.get_head_mesh().elm.nr), f"rand_elm"
    )
    roi_result_vis.get_head_mesh().add_node_field(
        np.random.rand(roi_result_vis.get_head_mesh().nodes.nr), f"rand_nodes"
    )


if roi_result_vis.has_surface_mesh():
    roi_result_vis.get_surface_mesh().add_element_field(
        np.random.rand(roi_result_vis.get_surface_mesh().elm.nr), f"rand_elm"
    )
    roi_result_vis.get_surface_mesh().add_node_field(
        np.random.rand(roi_result_vis.get_surface_mesh().nodes.nr), f"rand_nodes"
    )

roi_result_vis.create_visualization()
print(np.any(roi_result_vis.get_head_mesh().field['roi'].value))

print(
    roi_result_vis.head_mesh_data_name_to_gmsh_view,
    roi_result_vis.surface_mesh_data_name_to_gmsh_view,
)

roi_result_vis.write_visualization(
    "/mnt/c/Users/torwo/Documents/Projects/simnibs4_examples/tes_optimize_ttf_focality/",
    "opt_result",
)
"""