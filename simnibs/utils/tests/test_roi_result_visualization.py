...
class TestRoiResultVisualization:
    ...
    def test_surface_rois(self, sphere3_msh: mesh_io.Msh, tmp_path):
        ...
        result_vis.surface_mesh_data_name_to_gmsh_view[
            "mesh_1__elm_test_2"
        ].VectorType = 6
        ...
        assert (
            int(result_vis.surface_mesh_opt.View[9].ColormapNumber) == 2
        )  # default value
        ...
        assert (
            int(result_vis.surface_mesh_opt.View[10].ColormapNumber) == 2
        )  # default value
    ...
    def test_volume_and_surface_rois(self, sphere3_msh: mesh_io.Msh, tmp_path):
        ...
        assert (
            int(result_vis.surface_mesh_opt.View[8].ColormapNumber) == 2
        )  # default value
        ...
        assert (
            int(result_vis.head_mesh_opt.View[9].ColormapNumber) == 2
        )  # default value
    ...
    def test_file_name_including_underscores(self, sphere3_msh: mesh_io.Msh, tmp_path):
        ...
        opt_2.add_view(ColormapNumber=10)
        geo_file_path = os.path.join(tmp_path, "test_2_TMS_coil_pos.geo")
        opt_2.add_merge(geo_file_path)
        mesh_io.write_geo_spheres(
            [[1, 2, 3], [3, 4, 5]], geo_file_path, name="spheres", mode="ba"
        )
