function err = nifti_save(hdr,niftifile)
...
%
% Modified by Guilherme Saturnino, SEP-2019
...
ext = niftifile((length(niftifile)-2):length(niftifile));
if(strcmpi(ext,'.gz'))
  gzip_needed = 1;
  niftifile = niftifile(1:length(niftifile)-3);
