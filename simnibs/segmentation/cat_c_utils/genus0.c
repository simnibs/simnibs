...
static int *g_axis_len, *g_stride;
static int paddeddims0[3];
...
static void *basic_calloc(int nelem, int elsize)
  {
...
static void *Gcalloc(int nelem, int elsize, int make_persist)
  {
  void **cl;
  int *p,j;
...
static int dist_squared(
  ...
  g_stride = (int *)Gcalloc(rank,sizeof(int),0);
