function varargout = cat_spm_preproc_run(job,action)
...
% Vfiles
%==========================================================================
function [Ym,Ycls] = spm_preproc_write8f(res,tc,bf,df,mrf,cleanup,bb,vx,Yclsout)
